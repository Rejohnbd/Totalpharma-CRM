      ...
      <div class="modal-header">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 0px">
          <li role="presentation" class="active">
            <a href="#newEvent" aria-controls="newEvent" role="tab" data-toggle="tab">
              <?php echo _l('utility_calendar_new_event_title'); ?>
            </a>
          </li>
          <li role="presentation">
            <a href="#newAppointment" class="rejohn" aria-controls="newAppointment" role="tab" data-toggle="tab">New appointment
            </a>
          </li>
        </ul>
      </div>
            ...
            <div role="tabpanel" class="tab-pane" id="newAppointment">
             <?php /*
              ...
              <!-- <div class="col-md-12"> -->
                ...
                <?php }
                // recurring
                $this->load->view('admin/z_extra_views/recurring_wrapper');
                // custom fields
...
<?php
   ...
   * Old File are exist named calender_template_old.php
   * Line no 187 to 189 commented. Here variable $appointment used for update
   * 
   * /
?>